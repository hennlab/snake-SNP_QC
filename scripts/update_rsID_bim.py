...
parser.add_option("--bim", help = "PLINK bim file to update SNP ID")
parser.add_option("--bed", help = "e.g. dbSNP build bed file")
parser.add_option("-f", "--format", default = "F", help = "T or F, formatting unmatched ID as chr:bp")
parser.add_option("-c", "--codechr", default = "T", help = "T or F")
parser.add_option("-o", "--out", default = "out")
